...
export  function Navbar(props){
  ...
  <nav class="navbar navbar-expand-lg navbar-light" style={{backgroundColor: "black"}}>
                    ...
                    <div>
                        <ul class="navbar-nav">
                            <li class="nav-item active">
                                <a class="navbar-brand"  style={{color: 'white'}}>XE-Ops | </a>
                            </li>
                            <li class="nav-item">
				...
				<li class="nav-item">
                                <Link className="nav-items" style={{paddingLeft:15, fontSize: 20,  color: "white", textDecoration: 'none'}} to='/ipslas'>IP Slas</Link>
                            </li>
                            <li class="nav-item">
                                <Link className="nav-items" style={{paddingLeft:15, fontSize: 20, color: "white", textDecoration: 'none'}} to="/ribstatus">RibStatus</Link>
                            </li>
                            <li class="nav-item">
                                <Link className="nav-items" style={{paddingLeft:15, fontSize: 20, paddingRight: 950, color: "white", textDecoration: 'none'}} to="/config">Cfg/Oper</Link>
                            </li>
                            <li class="nav-item">
                ...
                <div className="row" style={{justifyContent: 'center'}}>
                    <div className="col-9">
                        <div className="card  text-white bg-dark mt-3">
                            ...
                            <div className="row" style={{justifyContent: 'center'}}>
                                <div className="col-3">
                                    <h5 style={{fontSize: '18px'}}>Host: {props.ip}</h5>
                                </div>
                                <div className="col-2">
