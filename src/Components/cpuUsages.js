        ...
        return <div className="col-12">
                ...
                <div className="card-body">
                    ...
                    <div className="row" style={{marginTop: '20px'}}>
                        ...
                        {proccessTableStatus ?<div className="row" style={{marginBottom: '10px', marginTop: '10px'}}/>: <div/>}
                        <div className="col-3">
                        ...
                        {memTableStatus ?<div className="row" style={{marginBottom: '10px', marginTop: '10px'}}/>: <div/>}
                        <div className="col-3">
