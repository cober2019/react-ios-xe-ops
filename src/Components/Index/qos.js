...
export  function Qos(props){
 ...
 if(Array.isArray(props.qos)){
        return  <div className="row">
                  <h5 classname="card-title mt-3">{props.interface.name}</h5>
                      { props.qos.map(queue => (
                        <div className="row">
                          <h5 classname="card-title mt-3">Allocation: {queue.allocation[0]}{queue.allocation[1]}</h5>
                          <div className="row">
                            {
    ...
    return  <div className="row">
      <h5 classname="card-title mt-3">{props.interface.name}</h5>
      <h6 classname="card-title mt-3">Allocation: {props.qos.allocation}</h6>
      <div className="row">
