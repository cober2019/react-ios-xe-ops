...
import { DmvpnTableHtml, DmvpnInterfacesTableHtml, TunnelInterfacesTableHtml, DmvpnHubsTableHtml, NbmaLocationTableHtml,
         OpsfTableHtml, OpsfIntsTableHtml  } from '../Other/chartConfigs';
import { DmvpnTopologyBuild, UpdateDmvpnTopology } from './topology';
import { OspfTopologyBuild, UpdateOspfTopology } from '../LayerThree/topology';
  ...
  useEffect(() => {
    if(dmvpnTableRef.current !== null){
      ...
      try{
        ...
        $(nbmaTableRef.current).DataTable().rows.add(Object.values(props.hubs))
                  ...
                  <div className="col-12">
                    ...
                    <div className="row">
                      <div className="col-12">
                          <div className="card text-white bg-dark mb-3 ">
                              <div className="card-body">
                                <h4 class="card-title mb-3">OSPF Neighbor/Interfaces</h4>
                                {ospfIntTable}
                              </div>
                            </div>
                          </div>
