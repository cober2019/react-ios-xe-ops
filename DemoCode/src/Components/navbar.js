  ...
  return  <div>
            <nav class="navbar navbar-expand-lg navbar-light" style={{backgroundColor: "black"}}>
                <div class="container-fluid">
                    <a class="navbar-brand"  style={{color: 'white'}}>IOS-XE-Ops | </a>
                 	<div>
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <Link className="nav-items" style={{paddingRight: 15, fontSize: 20, color: "white", textDecoration: 'none'}} to="/index">Home</Link>
                            </li>
                            <li class="nav-item">
                            <Link className="nav-items" style={{fontSize: 20, paddingRight: 1120, color: "white", textDecoration: 'none'}} to="/layerTwo">LayerTwo</Link>
                                </li>
                            <li class="nav-item">
